...
echo "****************************SORT SINGLET-DOUBLET-TRIPLET-COMBINATION****************************"

singlet_combinations=( ${!singlet_frequency[@]} )
singlet_combination_percentages=( ${singlet_frequency[@]} )
echo "sorted singlet percentages : ${singlet_combination_percentages[@]}"

doublet_combinations=( ${!doublet_frequency[@]} )
doublet_combination_percentages=( ${doublet_frequency[@]} )
echo "sorted doublet percentages : ${doublet_combination_percentages[@]}"

triplet_combinations=( ${!triplet_frequency[@]} )
triplet_combination_percentages=( ${triplet_frequency[@]} )
echo "sorted triplet percentages : ${triplet_combination_percentages[@]}"

echo "****************************SORT SINGLET-DOUBLET-TRIPLET-WINNING-COMBINATION****************************"

winning_combinations=( ${singlet_combinations[@]} ${doublet_combinations[@]} ${triplet_combinations[@]} )
winning_combination_percentages=( ${singlet_combination_percentages[@]} ${doublet_combination_percentages[@]} ${triplet_combination_percentages[@]} )
echo "sorted winning percentages : ${winning_combination_percentages}"
